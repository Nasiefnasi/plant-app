...
import 'package:uidesign/view/cartpage/cartlistmodel.dart';
                      ...
                      child: Container(
                          ...
                          child: Column(children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                child: Row(children: [
                                  15.widthBox,
                                  "Make Payment".text.bold.size(Vx.dp20).make(),
                                  const Spacer(),
                                  Container(
                                      child: const Row(
                                          mainAxisAlignment:
                        ...
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(
                                  "image/cart bottom card-01.png",
                                ),
                                fit: BoxFit.fill)),
                        height: mediaqurey.height * .25,
                      ),
                    ))
              ]),
            ),
